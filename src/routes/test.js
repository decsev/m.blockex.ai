    ...
    render() {
        ...
        const row = (rowData, sectionID, rowID) => {
            ...
            return (
                ...
                >
                    <div style={{
                        height: '50px', lineHeight: '50px', color: '#888', fontSize: '18px', borderBottom: '1px solid #ddd',
                    }}
                    >
                        {obj.title}
                    </div>
                    <div style={{ display: 'flex', padding: '15px' }}>
                        ...
                        <div style={{ display: 'inline-block' }}>
                            <div style={{
                                marginBottom: '8px', color: '#000', fontSize: '16px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', maxWidth: '250px',
                            }}
                            >{obj.des}-{rowData}
                            </div>
